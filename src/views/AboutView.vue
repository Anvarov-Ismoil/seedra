<template>
  <section class="about">
    <div class="container flex flex-wrap items-center justify-center gap-10 lg:flex-nowrap">
      <div class="content flex justify-center flex-col  mx-auto">
        <h1 class="text-[22px] font-semibold w-full max-w-[580px] mb-8  xs:text-4xl">Seedra helps to grow fast and efficiant</h1>
        <p class="w-full max-w-[521px] mb-7 font-light leading-7" >
        ...
        <p class="w-full max-w-[521px] font-light leading-7">
